...
const CampeonatoAoVivoScreen2 = ({route}) => {
    ...
    return (
        <Container>
            ...
            <Row>
                <InputValor placeholder={'Valor'} value={valorAposta} onChangeText={handleValorApostaChange} />
...
export default CampeonatoAoVivoScreen2;